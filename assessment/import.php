            ...
            <div class="col-lg-14 col-md-11 col-sm-2 col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      ...
                      <!--
                       <div id="success_msg" class="alert alert-success fade" style="position:relative">
                         <button href="#" type="button" class="close">&times;</button>
                         <a href="#" class="close" data-dismiss="alert">&times;</a> 
                          <strong>Success!</strong> File has been imported successfully. 
                       </div>
                       -->

<!--
                      <div id="error_msg"  class="alert alert-danger alert-block fade">
                        <button href="#" type="button" class="close">&times;</button>
                          <a href="#" class="close" data-dismiss="alert">&times;</a>
                          <strong>Error!</strong> Please Uplaod the Excel File Only. 
                      </div>

                      
                       <div id="success_msg" class="alert alert-success fade in" style="display: none;position:relative">
                            <a href="#" class="close" data-dismiss="alert">&times;</a>
